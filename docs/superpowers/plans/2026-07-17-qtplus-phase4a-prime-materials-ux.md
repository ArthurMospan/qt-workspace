...
Українські форми числівника («1 голос», «2-4 голоси», «5+ голосів») — спрощений варіант підходу з `pluralProjects` Фази 2.

**Що саме тут неправильно** (виправлено після рев'ю Task 8 — попередня редакція цього абзацу просто брехала): 11-14 обробляються **вірно**, хай і випадково — вони падають у кошик `голосів`, який для них і потрібен. Реальна дірка інша й ширша: будь-яке число **≥20 з останньою цифрою 1** дасть «21 голосів» замість «21 голос», а з останньою цифрою **2-4** — «22 голосів» замість «22 голоси».

Лишаємо свідомо: опитування тут — це кілька людей з команди проєкту, до 20 голосів воно не доростає. Якщо доросте — узагальнити наявний `pluralProjects` у спільний хелпер, а не латати на місці.

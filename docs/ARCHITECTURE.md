...
- «Огляд», «Продуктивність», «Команда» — `periodTimeLogWindow`: обраний період,
...
loggedAt, issueId)`. `loggedAt` іде першим, бо діапазон дат вибірковіший і саме
він має обмежувати скан.
...
**Хто що читає.** «Огляд», «Продуктивність» і «Команда» — це суми, тож вони
читають дні: плитки, «Куди пішов час», колонка часу в «По проєктах», хвилини
кожної людини в командній таблиці. Жодного сирого лога вони не відкривають.

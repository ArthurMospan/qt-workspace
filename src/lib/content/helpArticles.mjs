...
export const HELP_ARTICLES = Object.freeze([
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'filters', title: 'Фільтри й посилання', paragraphs: ['Обрані фільтри та вибір «дошка / список» показані в адресі сторінки. Тому дошку з фільтрами можна додати в закладки, надіслати колезі або відкрити на іншому пристрої — вона відкриється рівно такою, якою ви її бачили. Кнопка «назад» у браузері скасовує останню зміну фільтра.'], bullets: ['Так само працюють «Мої завдання» та «Спринти».', 'Посилання з фільтрами завжди має перевагу: воно показує стан відправника, а не ваш попередній.', 'Адреса без фільтрів відновлює ваш попередній перегляд цього екрана.', 'Фільтр у стані «всі» в адресі не показується.'] },

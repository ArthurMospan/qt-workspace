...
export const HELP_ARTICLES = Object.freeze([
  ...
  },
  {
    ...
    title: 'Підзадачі, зв’язки та дублювання', category: 'work', summary: 'Однорівнева hierarchy, логічні залежності та безпечні копії.',
    keywords: ['підзадача', 'parent', 'зв’язок', 'блокує', 'дублювати', 'кошик'], updatedAt: UPDATED_AT,
    relatedRoutes: ['/[projectId]/issue/[issueId]'], minimumRole: 'member', relatedIds: ['creating-issues', 'security-and-access'],
    sections: [
      { id: 'hierarchy', title: 'Підзадачі', paragraphs: ['QuickTeam підтримує один рівень parent/subtask. Батьківська задача показує прогрес дітей; закриття може бути заблоковане, доки відкриті підзадачі або залежності. Зміна hierarchy проходить через серверний маршрут із перевіркою проєкту й циклів.'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'files', title: 'Вкладення', paragraphs: ['Вкладення повідомлення мають приватний шлях доступу; файл не стає публічним через копіювання посилання.'] },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'deletion', title: 'Видалення', paragraphs: ['Задача видаляється у recoverable server trash з перевіркою підзадач і забілінгованого часу. Видалення організації вимкнене. Щодо видалення облікового запису або персональних даних зверніться до підтримки OneB.'] },
    ],
  },
  {

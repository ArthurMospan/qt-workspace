 ...
 * «є». Тож рейка підписувалась дефолтом і фарбувалась стандартною темною
 * темою. Гірше: обидва кеші анти-мигання записувались із тієї ж заглушки,
 * тому наступне завантаження стартувало з дефолту знову. Кеш, який існує
 * проти мигання, сам його й відтворював.
 *

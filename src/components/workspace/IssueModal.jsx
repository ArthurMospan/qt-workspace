...
export default function IssueModal({ issue, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:pt-8 sm:pb-8 sm:px-4" onClick={onClose}>
      ...
      <div
        className="relative bg-white rounded-t-[24px] sm:rounded-[24px] shadow-2xl w-full max-w-[1200px] h-full max-h-[94vh] sm:max-h-[90vh] flex flex-col overflow-hidden pb-[env(safe-area-inset-bottom)] sm:pb-0"

        ...
        <Dialog
          ...
          footer={(
            <Button
              ...
              // does nothing else. Not `dismiss` all the same — it is the whole
              // footer, and a lone button reads as the action to take rather
              // than as a second ×, so a phone keeps it.

    ...
    <div className="flex flex-col gap-[32px]">
      ...
      >
        <Card preset="borderless" padding="lg" className="w-full max-w-[520px]">
          ...
          <SettingRow label="Вигляд порталу" desc="Свій: «OneB Підтримка»" onClick={() => {}} value="Змінено 27 серп" />

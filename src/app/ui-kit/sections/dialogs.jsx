  ...
  return (
    <ConfirmProvider>
      ...
      <PreviewBlock
        ...
        description="Точний shared organism з проєкту: правий sm sheet, як форма створення проєкту. «Скасувати» позначена `dismiss` — вона нічого не робить, крім того, що робить × у шапці, тому нижче md футер її не малює: на телефоні футер — це стовпчик рядків на всю ширину, і дві однакові відповіді коштували б два з них. Тут поряд стоїть «Зберегти», тож смуга футера лишається, а зникає тільки зайвий рядок. Там, де така кнопка в футері одна («Деталі події» для читача, чернетка рахунку, розбивка дня в таймшиті, «Готово» у шторці фільтрів PageHeader і в налаштуваннях колонок «Моїх завдань»), `dismiss` не ставлять узагалі: самотня кнопка не заважає, а на телефоні одразу показує, що звідси можна зробити, — такий футер виглядає однаково на телефоні й на десктопі."

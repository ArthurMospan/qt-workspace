  ...
  return (
    <div className="flex flex-col gap-[32px]">
      <PreviewBlock
        ...
        description="Три різні речі, і виглядають вони по-різному: ключ — моноширинний, бо це ідентифікатор, який перенабирають; проєкт — звичайний текст, бо це назва, яку читають; батько — теж ключ, тому той самий шрифт і розмір, але світліший і легший: перший ключ називає це завдання, другий — те, під яким воно висить. Іконка справжня, а не символ «↳», у якого немає однакових метрик у різних шрифтах. Ключ не вигадується: завдання без ключа не показує нічого замість «PRE-a3f2» зі шматка id документа."

...
// Where a component actually lives, opened from its own preview.
//
...
//
// Everything is read from kit-usage.generated.json (npm run kit:scan): the
// per-variant counts, the screens each variant appears on, and the exact
// file:line list. Nothing is hand-maintained.

        ...
        <div className="backdrop-blur-xl bg-white/[0.02] border border-white/[0.05] p-8 md:p-10 rounded-[32px] shadow-[0_24px_60px_rgba(0,0,0,0.5)]">
          ...
          <div className="space-y-6 text-[14px] leading-relaxed text-white/70">
            ...
            <section>
              ...
              <p>
                Ваші дані використовуються виключно для забезпечення роботи внутрішнього таск-менеджера: відображення виконавців у завданнях, оновлення статусів у реальному часі, надсилання внутрішніх сповіщень та інтеграції з клієнтським порталом. Ми не передаємо ваші дані третім особам.
              </p>
            </section>
